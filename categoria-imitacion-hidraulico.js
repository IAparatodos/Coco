/**
 * JavaScript para Categoría Imitación Hidráulico (ID: 2082)
...
(function($) {
     ...
     */
    function moverBotonFiltroImitacion() {
        var $boton = $('.wpc-filters-open-button-container');
        var $destino = $('#destino-filtro-adria-imitacion');
    ...
    function scrollSuaveAlCatalogo() {
        var $catalogo = $('#catalogo-imitacion');
    ...
    $(document).ready(moverBotonFiltroImitacion);
    
    // Backup: ejecutar después de 1.5s por si el DOM no estaba listo
    setTimeout(moverBotonFiltroImitacion, 1500);
