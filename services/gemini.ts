...
import { getActiveCharacterPrompt, CHARACTERS } from "../agents/characters";
...
const storySchema: Schema = {
  ...
  properties: {
    ...
    nextCharacters: {
      ...
      description: "Personajes que aparecerán en el siguiente panel. Siempre incluir 'coco' y 'narrador'.",
    },
    choices: {
      type: Type.ARRAY,
      items: {
...
export const generateStorySegment = async (
  ...
  try {
    ...
    const prompt = `
      ...
      Asegúrate de que la trama avance. Cocó debe interactuar con los personajes presentes y con elementos de la tienda de azulejos (baldosas, grifos, bañeras, cajas).
    ...
    if (!nextChars.includes('coco')) nextChars.unshift('coco');
