...
function adrihosan_contacto_contenido() {
    ...
    <!-- HERO (patron corporativo: hero-section-container + adrihosan-full-width-block) -->
    <section class="hero-section-container adrihosan-full-width-block contacto-hero" style="background-image: url('https://www.adrihosan.com/wp-content/uploads/2025/08/home-Adrihosan.jpg');">
        <div class="hero-content contacto-hero-content">
