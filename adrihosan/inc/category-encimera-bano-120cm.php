<?php
/**
 * Category: Encimera de bano 120 cm 1 seno (ID: 5387)
 *
 * Standalone, INDEPENDIENTE de la plantilla compartida
 * category-encimera-bano-1seno.php (esa sigue sirviendo al 5388).
 * Esta cat tiene su propio PHP para customizar libremente sin
 * afectar al 140 cm.
 *
 * Keyword lider: "encimera de bano 120 cm 1 seno"  10 clicks / 476 impr GSC.
 * Producto de margen (Solid Surface, linea propia Solidker). El ancho
 * con MAS VOLUMEN del silo (mueble doble cajon, par de banos).
 *
 * Angulo SERP: encimera-lavabo integrada de Solid Surface, seno unico
 * con posicion a elegir (centrado / derecha / izquierda / desplazado),
 * fabricacion a medida, sobre mueble o suspendida, blanca o negra.
 *
 * Hueco a explotar: nadie posiciona BIEN ancho exacto + "1 seno" +
 * a medida + Valencia con stock real (Anyway Solid, Coycama, grupodpl).
 *
 * Buyer persona PRIMARIO: Pareja Reformadora (estetica + durabilidad +
 * asesoramiento por WhatsApp). Capa tecnica para quien mira
 * espesor/seno/instalacion.
 *
 * REGLAS DURAS (briefing junio 2026):
 * - H1 SIEMPRE via adrihosan_h1_dinamico("Encimera de bano 120 cm 1 seno").
...
// ============================================================================
// CATEGORIA 5387 - ENCIMERA DE BANO 120 CM 1 SENO (standalone)
// ============================================================================

function adrihosan_categoria_encimera_bano_120cm_contenido_superior() {
    $term      = get_term( 5387, 'product_cat' );
    ...
    <section class="hero-section-container adrihosan-full-width-block" style="background-image: url('https://www.adrihosan.com/wp-content/uploads/2026/06/lavabo-120-cm-1-seno.jpg');">
        <div class="hero-content">
            <h1><?php echo adrihosan_h1_dinamico( 'Encimera de ba&ntilde;o 120 cm 1 seno' ); ?></h1>
            <p class="hero-tagline">Solid Surface a medida, con el seno donde t&uacute; lo quieras.</p>
            <div class="hero-buttons">
                <a href="#catalogo-enc120-1seno" class="hero-btn primary">Ver Cat&aacute;logo</a>
                <a href="https://api.whatsapp.com/send?phone=+34961957136&text=Hola,%20quiero%20una%20encimera%20de%20ba%C3%B1o%20de%20120%20cm%20con%201%20seno%20a%20medida" class="hero-btn secondary" target="_blank">Pedir a medida por WhatsApp</a>
            </div>
        </div>
    </section>
        ...
        <div class="ap-value-wrapper">
            <div class="section-header">
                <p class="section-intro">
                    Una <strong>encimera de ba&ntilde;o de 120 cm con 1 seno</strong> en Solid Surface convierte el mueble en una pieza continua, sin juntas y sin poros. La fabricamos a medida en nuestra l&iacute;nea Solidker: eliges medida, posici&oacute;n del seno y color, y te la entregamos lista para colocar.
                </p>
            </div>
    ...
    <div id="destino-filtro-adria-enc120-1seno" class="solo-movil-filtro" style="display:none; text-align:center; margin: 20px 0 40px 0; min-height: 60px;"></div>
    <div class="filter-container-master" style="margin-bottom:50px;"><?php echo do_shortcode('[fe_widget id="428107"]'); ?></div>

    <!-- 3. STORYTELLING -->
    <section class="enc120-1seno-storytelling adrihosan-full-width-block">
        <div class="enc120-1seno-storytelling-wrapper">
            <h2>Por qu&eacute; una encimera de ba&ntilde;o de 120 cm con 1 seno en Solid Surface</h2>
            <div class="storytelling-text">
                ...
                <p>El material es <strong>resina acr&iacute;lica con cargas minerales</strong>: c&aacute;lido al tacto, reparable con un lijado suave, preparado para grifer&iacute;a (mural o sobre encimera). El ancho de 120 cm es el de m&aacute;s volumen del silo: cabe c&oacute;modamente sobre un mueble de doble caj&oacute;n y deja sitio para un grifo mural y los accesorios habituales. Si prefieres lavabo aparte, mira los <a href="https://www.adrihosan.com/categoria-producto/sanitarios/lavabos/lavabo-de-resina/">lavabos de Solid Surface</a> o el cat&aacute;logo madre de <a href="https://www.adrihosan.com/categoria-producto/sanitarios/encimeras-bano/">encimeras de ba&ntilde;o</a>.</p>
            </div>
        </div>
    </section>

    <!-- 4. TITULO CATALOGO -->
    <div id="catalogo-enc120-1seno" class="product-loop-header">
        <h2 class="product-loop-title">Cat&aacute;logo de encimeras de 120 cm con 1 seno</h2>
...
function adrihosan_categoria_encimera_bano_120cm_contenido_inferior() {
    ?>
    </div><!-- /fe-products-wrapper -->

    <!-- 6. CTA INTERMEDIO -->
    <section class="enc120-1seno-cta-mid adrihosan-full-width-block">
        <div class="cta-mid-wrapper">
            ...
            <a class="cta-mid-btn" href="https://api.whatsapp.com/send?phone=+34961957136&text=Hola,%20te%20paso%20la%20medida%20de%20mi%20mueble%20para%20una%20encimera%20de%20120%20cm%201%20seno%20a%20medida" target="_blank">WhatsApp 96 195 71 36</a>
        </div>
    </section>

    <!-- 7. COMPARATIVA: MEDIDAS, SENO Y ACABADO -->
    <section class="enc120-1seno-comparativa adrihosan-full-width-block">
        <div class="enc120-1seno-comparativa-wrapper">
            <h2>Encimera de ba&ntilde;o 120 cm 1 seno: medidas, seno y acabado para acertar</h2>
            ...
            <div class="comparativa-table-wrapper">
                <table class="comparativa-table">
                    <tbody>
                        <tr><td><strong>Ancho</strong></td><td>120 cm</td></tr>
    ...
    <section class="enc120-1seno-asesoramiento adrihosan-full-width-block">
        <div class="enc120-1seno-asesoramiento-wrapper">
            <h2>Tu encimera de ba&ntilde;o 120 cm 1 seno, fabricada a tu medida</h2>
            ...
            <div class="asesoramiento-cta">
                <a href="https://api.whatsapp.com/send?phone=+34961957136&text=Hola,%20quiero%20pedir%20presupuesto%20de%20encimera%20120%20cm%201%20seno%20a%20medida%20en%20Solidker" class="bumper-btn" target="_blank">Pedir presupuesto a medida</a>
            </div>
        </div>
    </section>

    <!-- 10. CATEGORIAS RELACIONADAS -->
    <section class="enc120-1seno-related adrihosan-full-width-block">
        <div class="enc120-1seno-related-wrapper">
            <h2>Tambi&eacute;n te puede interesar</h2>
            <div class="related-pills">
                <a class="related-pill" href="https://www.adrihosan.com/categoria-producto/sanitarios/encimeras-bano/encimera-bano-140-cm/">Encimera ba&ntilde;o 140 cm 1 seno</a>
    ...
    <section class="faq-section-common adrihosan-full-width-block">
        <div class="faq-wrapper-common">
            <h2 class="faq-main-title-common">Preguntas frecuentes sobre la encimera de ba&ntilde;o 120 cm 1 seno</h2>
            <div class="faq-items-wrapper">
                ...
                <div class="faq-item-common">
                    <button class="faq-question-common"><span>&iquest;Puedo elegir d&oacute;nde va el seno en una encimera de 120 cm?</span><span class="faq-icon-common">+</span></button>
                    <div class="faq-answer-common"><p>S&iacute;. En las encimeras a medida eliges <strong>posici&oacute;n del seno</strong>: centrado, derecha, izquierda o desplazado. Es justo lo que pide mucha reforma cuando el mueble de 120 cm tiene una columna de cajones en un lado.</p></div>
                </div>

                <div class="faq-item-common">
                    <button class="faq-question-common"><span>&iquest;Qu&eacute; medidas tiene la encimera de 120 cm?</span><span class="faq-icon-common">+</span></button>
                    <div class="faq-answer-common"><p>Ancho <strong>120 cm</strong>, <strong>fondo &asymp; 46 cm</strong> y <strong>espesor &asymp; 1,2 cm</strong>. Todas las cotas son ajustables al pedir, dentro de los m&iacute;nimos y m&aacute;ximos de fabricaci&oacute;n.</p></div>
                </div>
                ...
                <div class="faq-item-common">
                    <button class="faq-question-common"><span>&iquest;Qu&eacute; colores hay disponibles?</span><span class="faq-icon-common">+</span></button>
                    <div class="faq-answer-common"><p>Tenemos <strong>blanco y negro</strong> como acabados habituales, y la <strong>carta Solidker completa</strong> para pedidos a medida (grises, tonos crema y especiales). Si tu reforma pide un color concreto, escr&iacute;benos y miramos qu&eacute; podemos servir y en qu&eacute; plazo.</p></div>
                </div>
    ...
    <section class="contact-help-common adrihosan-full-width-block">
        <div class="contact-help-wrapper">
            <div class="contact-intro">
                ...
                <div><h2>&iquest;Tu medida no es exacta? Te la fabricamos.</h2><p>Soy Ricardo. M&aacute;ndame foto de tu mueble de 120 cm y los cm exactos, y te paso plazo y precio de la encimera a medida en Solidker.</p></div>
            </div>
            <div class="contact-options-grid-common">
                ...
                <a href="https://api.whatsapp.com/send?phone=+34961957136&text=Hola,%20quiero%20una%20encimera%20de%20ba%C3%B1o%20de%20120%20cm%201%20seno%20a%20medida" class="contact-option-common"><div class="icon">💬</div><div class="label">Whatsapp</div></a>
