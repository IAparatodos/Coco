...
function adrihosan_metro_inferior_final() {
    ...
    <section id="contacto-metro" class="contact-help-common adrihosan-full-width-block">
        <div class="contact-help-wrapper">
            <div class="contact-intro">
                <img src="https://www.adrihosan.com/wp-content/uploads/2025/04/Ricardo-faq.jpg" alt="Foto de Ricardo, experto en materiales de Adrihosan">
                <div><h2>&iquest;Buscas un color espec&iacute;fico?<span>Soy Ricardo. Tenemos much&iacute;simos colores.</span></h2></div>
            </div>
            <div class="contact-options-grid-common">
                ...
                <a href="https://api.whatsapp.com/send?phone=+34961957136&text=Hola,%20necesito%20asesoramiento%20sobre%20azulejo%20metro" class="contact-option-common">
                    <div class="icon">💬</div>
