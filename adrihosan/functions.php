...
function adrihosan_master_controller_cpu_fix() {
    ...
    switch($cat_id) {
        ...
        case 5467: // Azulejos grandes para banos (hija de 5466, recreada 12-ago)
            ...
            break;
        case 5468: // Azulejos grandes para cocina (hija de 5466, recreada 12-ago)
            adrihosan_setup_azulejos_grandes_cocina_cpu_fix();
            break;
        ...
        case 5393: // Suelo para garaje (silo Pavimentos)
            ...
            break;
        case 5394: // Suelo para ducha de obra (silo Pavimentos)
            adrihosan_setup_suelo_ducha_obra_cpu_fix();
            break;
        ...
        case 5397: // Suelo Exterior Antideslizante (silo Pavimentos/Exterior)
            ...
            break;
        case 5396: // Mueble de baño 120 cm 1 seno desplazado (silo Muebles de baño, parent 99)
            adrihosan_setup_mueble_120_desplazado_cpu_fix();
            break;
        ...
        case 2861: // Duplach platos de ducha (hoja de MARCA, hija de 86)
            ...
            break;
        case 2863: // Fiora platos de ducha (hoja de MARCA, hija de 86)
            adrihosan_setup_fiora_cpu_fix();
            break;
        ...
        case 2676: // Lavabo gris (subcategoria del silo Lavabos, reconstruccion)
            ...
            break;
        case 2649: // Lavabo piedra (consolidacion piedra/marmol/granito, 14-jul-2026)
            adrihosan_setup_lavabo_piedra_cpu_fix();
            break;
        ...
        case 2699: // Lavabo ovalado (subcategoria del silo Lavabos, reconstruccion)
            ...
            break;
        case 2669: // Lavabo rustico (subcategoria del silo Lavabos, reconstruccion)
            adrihosan_setup_lavabo_rustico_cpu_fix();
            break;
        case 2668: // Lavabo redondo (subcategoria del silo Lavabos, reconstruccion)
            adrihosan_setup_lavabo_redondo_cpu_fix();
            break;
        ...
        case 91: // Lavabo sobre encimera (cabecera del silo Lavabos, reconstruccion)
            ...
            break;
        case 2665: // Lavabos baratos (subcategoria del silo Lavabos, reconstruccion)
            adrihosan_setup_lavabos_baratos_cpu_fix();
            break;
        case 2703: // Lavabos de colores (subcategoria del silo Lavabos, reconstruccion)
            adrihosan_setup_lavabos_de_colores_cpu_fix();
            break;
        case 2723: // Lavabos negros (subcategoria del silo Lavabos, reconstruccion)
            adrihosan_setup_lavabos_negros_cpu_fix();
            break;
        case 2644: // Lavabos pequenos (subcategoria del silo Lavabos, reconstruccion)
            adrihosan_setup_lavabos_pequenos_cpu_fix();
            break;
...
function adrihosan_setup_azulejos_grandes_cocina_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_azulejos_grandes_cocina_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_azulejos_grandes_cocina_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_azulejos_grandes_cocina_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_azulejos_grandes_cocina_contenido_inferior', 99);
    }
}
...
// Cat 5394 - Suelo para ducha de obra (silo Pavimentos). Guards
// function_exists por si el inc no se subio (patron CLAUDE.md).
function adrihosan_setup_suelo_ducha_obra_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_suelo_ducha_obra_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_suelo_ducha_obra_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_suelo_ducha_obra_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_suelo_ducha_obra_contenido_inferior', 99);
    }
}

// Cat 5395 - Revestimiento de chimenea (silo Azulejos). Guards
// function_exists por si el inc no se subio (patron CLAUDE.md).
function adrihosan_setup_revestimiento_chimenea_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_revestimiento_chimenea_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_revestimiento_chimenea_contenido_superior', 5);
    }
...
// Cat 5396 - Mueble de baño 120 cm 1 seno desplazado (silo Muebles de baño, parent 99).
// Guards function_exists por si el inc no se subio (patron CLAUDE.md).
function adrihosan_setup_mueble_120_desplazado_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_mueble_120_desplazado_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_mueble_120_desplazado_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_mueble_120_desplazado_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_mueble_120_desplazado_contenido_inferior', 99);
    }
}
...
function adrihosan_setup_espejos_redondo_cpu_fix() {
    ...
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    if ( function_exists( 'adrihosan_espejo_redondo_bano_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_espejo_redondo_bano_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_espejo_redondo_bano_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_espejo_redondo_bano_contenido_inferior', 99);
    }
    add_action('wp_head', 'adrihosan_ocultar_filtros_legacy', 5);
}
...
function adrihosan_setup_acquabella_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_acquabella_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_acquabella_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_acquabella_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_acquabella_contenido_inferior', 99);
    }
}

function adrihosan_setup_fiora_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_fiora_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_fiora_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_fiora_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_fiora_contenido_inferior', 99);
    }
}

function adrihosan_setup_duplach_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_duplach_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_duplach_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_duplach_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_duplach_contenido_inferior', 99);
    }
}
...
// Cat 2649 - Lavabo piedra (pagina unica de la familia piedra/marmol/granito
// tras la consolidacion del 14-jul-2026; marmol 2664 borrada con 301 aqui).
function adrihosan_setup_lavabo_piedra_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabo_piedra_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabo_piedra_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_lavabo_piedra_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_lavabo_piedra_contenido_inferior', 99);
    }
}

// Cat 2726 - Lavabo minimalista (reconstruccion: la pagina en vivo era el
// archivo por defecto; la descripcion editable es una linea de relleno y sera
// reemplazada por el Archivo 2; la plantilla no depende de ella).
function adrihosan_setup_lavabo_minimalista_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabo_minimalista_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabo_minimalista_contenido_superior', 5);
    }
...
// Cat 2669 - Lavabo rustico (reconstruccion: archivo por defecto con metas de
// relleno; la descripcion editable sera reemplazada por el Archivo 2).
function adrihosan_setup_lavabo_rustico_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabo_rustico_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabo_rustico_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_lavabo_rustico_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_lavabo_rustico_contenido_inferior', 99);
    }
}

// Cat 2668 - Lavabo redondo (reconstruccion: archivo por defecto con metas de
// relleno; la descripcion editable sera reemplazada por el Archivo 2).
function adrihosan_setup_lavabo_redondo_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabo_redondo_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabo_redondo_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_lavabo_redondo_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_lavabo_redondo_contenido_inferior', 99);
    }
}

// Cat 2701 - Lavabo verde (reconstruccion: archivo por defecto con descripcion
// basura de ChatGPT; la descripcion editable sera reemplazada por el Archivo 2).
function adrihosan_setup_lavabo_verde_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabo_verde_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabo_verde_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_lavabo_verde_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_lavabo_verde_contenido_inferior', 99);
    }
}
...
// Cat 2665 - Lavabos baratos (reconstruccion: plantilla Woo por defecto con
// descripcion de ChatGPT; la descripcion editable sera reemplazada por el
// Archivo 2). OJO: el copy lleva precios verificados el 20-jul-2026.
function adrihosan_setup_lavabos_baratos_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabos_baratos_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabos_baratos_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_lavabos_baratos_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_lavabos_baratos_contenido_inferior', 99);
    }
}

// Cat 2703 - Lavabos de colores (reconstruccion: plantilla Woo por defecto con
// descripcion de ChatGPT y FAQ que inventaba una garantia). Un PRODUCTO le
// ganaba a la categoria en "lavabos de colores" (pos 2,4 vs 12,2).
// OJO: el copy lleva precios verificados el 20-jul-2026.
function adrihosan_setup_lavabos_de_colores_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabos_de_colores_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabos_de_colores_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_lavabos_de_colores_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_lavabos_de_colores_contenido_inferior', 99);
    }
}

// Cat 2723 - Lavabos negros (reconstruccion: la ficha del TOPI negro servia
// "lavabo negro" en pos 4,7 mientras la categoria vivia en pos 31-40; la
// seccion de la cal alimenta el pos 1 en "como limpiar un lavabo negro").
// OJO: el copy lleva precios verificados el 23-jul-2026.
function adrihosan_setup_lavabos_negros_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_lavabos_negros_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_lavabos_negros_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_lavabos_negros_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_lavabos_negros_contenido_inferior', 99);
    }
}

// Cat 2644 - Lavabos pequenos (reconstruccion: las queries cabeza "lavabo
// pequeno" 3.284 impr/12m y "lavabos pequenos baratos" 1.903 las servian
// URLs fantasma cuyos 301 ya desembocan aqui; 78 productos tras la curacion
// <=48 ancho O <=32 fondo). OJO: el copy lleva precios verificados el
// 23-jul-2026.
function adrihosan_setup_lavabos_pequenos_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_2644_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_2644_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_2644_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_2644_contenido_inferior', 99);
    }
}

// Cat 92 - Lavabos suspendidos (reconstruccion: el post de la altura le
// pisaba la transaccional a la categoria; "lavabo suspendido" 952 impr/12m
// con la categoria en pos 40,2. Lo informativo se queda en el post
// /a-que-altura-se-pone-un-lavabo-suspendido/; la categoria reclama la
// transaccional. 19 productos, sin curacion). OJO: el copy lleva precios
// verificados el 23-jul-2026.
function adrihosan_setup_lavabos_suspendidos_cpu_fix() {
    add_filter('woocommerce_show_page_title', '__return_false');
    remove_all_actions('woocommerce_archive_description');
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20);
    remove_action('woocommerce_before_shop_loop', 'woocommerce_output_product_categories', 10);
    ...
    if ( function_exists( 'adrihosan_categoria_92_contenido_superior' ) ) {
        add_action('woocommerce_before_shop_loop', 'adrihosan_categoria_92_contenido_superior', 5);
    }
    if ( function_exists( 'adrihosan_categoria_92_contenido_inferior' ) ) {
        add_action('woocommerce_after_shop_loop', 'adrihosan_categoria_92_contenido_inferior', 99);
    }
}
...
$_adri_p = get_template_directory() . '/inc/category-espejo-redondo-bano.php'; if ( file_exists( $_adri_p ) ) { require $_adri_p; }
...
$_adri_p = get_template_directory() . '/inc/category-mueble-bano-120cm-1-seno-desplazado.php'; if ( file_exists( $_adri_p ) ) { require $_adri_p; }  // Cat 5396 - Mueble de baño 120 cm 1 seno desplazado (silo Muebles de baño)
...
$_adri_modular_incs = array(
    ...
    '/inc/category-lavabos-baratos.php',    // Cat 2665 - Lavabos baratos (subcategoria del silo Lavabos, reconstruccion)
    '/inc/category-lavabos-de-colores.php', // Cat 2703 - Lavabos de colores (subcategoria del silo Lavabos, reconstruccion)
