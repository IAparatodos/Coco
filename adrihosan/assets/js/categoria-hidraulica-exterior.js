/**
 * JavaScript para Categoría Baldosa Hidráulica Original - Exterior (ID: 4869)
...
(function($) {
     ...
     */
    function moverBotonFiltroExterior() {
        var $boton = $('.wpc-filters-open-button-container');
        var $destino = $('#destino-filtro-adria-exterior');
    ...
    function scrollSuaveAlCatalogo() {
        var $catalogo = $('#catalogo-exterior');
    ...
    $(document).ready(moverBotonFiltroExterior);
    
    // Backup: ejecutar después de 1.5s por si el DOM no estaba listo
    setTimeout(moverBotonFiltroExterior, 1500);
