...
<div class="site-search">
	...
	<div class="search-button"><img src="<?php echo get_theme_file_uri('/img/search.png');?>" width="20" height="20" alt="Buscar"></div>
	<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) );?>">
		...
		<button type="submit" class="search-submit" value=""><img src="<?php echo get_theme_file_uri('/img/search.png');?>" width="20" height="20" alt="Buscar"></button>
	</form>
