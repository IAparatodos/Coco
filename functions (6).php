...
function adrihosan_contenido_inferior_bano() {
	if ( is_product_category( 2083 ) && ! is_singular('product') ) {
		...
		<section class="ap-faq-section adrihosan-full-width-block"><div class="ap-faq-wrapper"><h2 class="ap-faq-main-title">Dudas Frecuentes sobre Azulejos para Baño</h2><div class="ap-faq-item"><button class="ap-faq-question"><span>¿El porcelánico imitación hidráulico es antideslizante?</span><span class="ap-faq-icon">+</span></button><div class="ap-faq-answer"><p>Sí, muchos de nuestros modelos porcelánicos tienen un acabado mate con propiedades antideslizantes (Clase 1 o C1), haciéndolos seguros para el suelo del baño. Para la zona de la ducha, recomendamos buscar modelos con una clasificación superior (Clase 2/C2 o superior) para una máxima seguridad.</p></div></div><div class="ap-faq-item"><button class="ap-faq-question"><span>¿Puedo ponerlo en la pared de la ducha?</span><span class="ap-faq-icon">+</span></button><div class="ap-faq-answer"><p>Absolutamente. El gres porcelánico es un material con una porosidad prácticamente nula, lo que lo hace 100% impermeable y perfecto para estar en contacto directo con el agua. No se verá afectado por la humedad, el moho o los productos de limpieza.</p></div></div><div class="ap-faq-item"><button class="ap-faq-question"><span>¿Qué junta de color debo usar?</span><span class="ap-faq-icon">+</span></button><div class="ap-faq-answer"><p>Depende del efecto que busques. Para un look continuo donde el diseño del azulejo es el protagonista, elige un color de junta lo más parecido posible a los tonos de la baldosa (un gris claro o un beige suelen funcionar bien). Para un efecto más marcado y gráfico, una junta de color oscuro (gris perla o antracita) resaltará la forma de cada pieza.</p></div></div></div></section>

		<section class="ap-help-section adrihosan-full-width-block"><div class="ap-help-wrapper"><div class="ap-help-intro"><img src="https://www.adrihosan.com/wp-content/uploads/2025/04/Ricardo-faq.jpg" alt="Foto de Ricardo, experto en materiales de Adrihosan"><div><h2>¿Necesitas un último consejo?<span>Soy Ricardo, tu experto en baños con carácter.</span></h2></div></div><div class="ap-contact-options-grid"><a href="https://www.adrihosan.com/contacto/#visita-exposicion-presencial" class="ap-contact-option"><div class="icon">📍</div><div class="label">Visita Presencial</div></a><a href="https://www.adrihosan.com/contacto/#visita-exposicion-videollamada" class="ap-contact-option"><div class="icon">💻</div><div class="label">Visita Virtual</div></a><a href="tel:+34961957136" class="ap-contact-option"><div class="icon">📞</div><div class="label">Teléfono</div></a><a href="https://api.whatsapp.com/send?phone=+34961957136&text=Hola,%20Necesito%20ayuda%20con%20los%20azulejos%20para%20baño" class="ap-contact-option"><div class="icon">💬</div><div class="label">Whatsapp</div></a><a href="mailto:hola@adrihosan.com" class="ap-contact-option"><div class="icon">✉️</div><div class="label">Email</div></a></div></div></section>
		<?php
	}
}
/******************************************************************************
