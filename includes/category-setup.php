...
function adrihosan_setup_wood_cpu_fix() {
    ...
    add_action('woocommerce_before_shop_loop', 'adrihosan_suelo_madera_contenido_superior', 5);
    add_action('woocommerce_after_shop_loop', 'adrihosan_suelo_madera_contenido_inferior', 99);
